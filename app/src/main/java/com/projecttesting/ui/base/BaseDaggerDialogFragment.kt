...
/**
 * Base [DaggerAppCompatDialogFragment] Class that binds [FragmentInteractionListener] when attached to activity.
 * Best use-case is a Dialog Fragment which contains injected dependencies.
 *
 */
abstract class BaseDaggerDialogFragment<T : ViewDataBinding> : DaggerAppCompatDialogFragment() {
